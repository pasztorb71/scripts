...
from MLFF.liquibase_gen.gen_table.Confluence import Confluence
from MLFF.liquibase_gen.gen_table.params import event_data
...
--comment {ticket_name} {tab_name.upper()} tábla létrehozása\n""" + search_path).replace('!schema!', '${schema_name}')
        ...
        return ("""--changeset bertalan.pasztor:${schema_name}-""" + f"""{sequence}
--comment {ticket_name} {tab_name.upper()} tábla létrehozása\n""" + search_path).replace('!schema!',
                                                                                                 '${schema_name}')
