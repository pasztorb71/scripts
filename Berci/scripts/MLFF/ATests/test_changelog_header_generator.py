...
from MLFF.liquibase_gen import Changelog_header_generator
...
--precondition-sql-check expectedResult:1 SELECT count(*) FROM information_schema.table_constraints WHERE constraint_schema = 'visual_check' AND table_name = 'check_package' AND constraint_name = 'ck_checkpack_status'
---------------------------------------------------------------------------------------------------
""", 'check_package')
