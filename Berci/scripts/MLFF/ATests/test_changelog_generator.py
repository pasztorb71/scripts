...
from MLFF.liquibase_gen import is_history_related_command, gen_history_command_from_command
...
class Test(TestCase):
    ...
    def test_gen_history_command_from_command(self):
        ...
        self.assertEqual(expected, gen_history_command_from_command('', stmt))
    ...
    def test_gen_history_command_from_command_not_null_handling(self):
        stmt = "ALTER TABLE psp_clearing.psp_clearing ADD psp_settlement_batch_id varchar(30) NOT NULL;"
        expected = "ALTER TABLE psp_clearing.psp_clearing$hist ADD psp_settlement_batch_id varchar(30) NULL;"
        self.assertEqual(expected, gen_history_command_from_command('', stmt))
