...
class Test(TestCase):
    def test_gen_port_databases_from_envs(self):
        expected = [['5432', 'core_customer'], ['5432', 'core_notification_dispatcher'], ['5432', 'core_template'],
                    ...
                    ['5432', 'core_genos'], ['5432', 'obu_obuprovider'], ['5432', 'liquibase_template'],
                    ...
                    ['5432', 'data_ingestion_meta'], ['5432', 'payment_account_info']]
